        ...
        <div className="faq14-container10 thq-flex-column">
          <div className="faq14-section-title thq-flex-column">
            <h2>
              {props.heading1 ?? (
                <Fragment>
                  <h2 className="faq14-text31 thq-heading-2">FAQs</h2>
                </Fragment>
              )}
            </h2>
            <p>
              {props.content1 ?? (
                <Fragment>
                  <p className="faq14-text33 thq-body-large">
            ...
            <div className="faq14-faq3">
              ...
              >
                <p>
                  {props.faq3Question ?? (
                    <Fragment>
                      <p className="faq14-text29 thq-body-large">
                        Frequently Asked Questions
                      </p>
                    </Fragment>
                  )}
            ...
            <div className="faq14-faq4">
              ...
              >
                <p>
                  {props.faq4Question ?? (
                    <Fragment>
                      <p className="faq14-text26 thq-body-large">
                        Frequently Asked Questions
                      </p>
                    </Fragment>
                  )}
        ...
        <div className="faq14-content1 thq-flex-column">
          <div className="faq14-content2">
            <h2>
              {props.heading2 ?? (
                <Fragment>
                  <h2 className="faq14-text30 thq-heading-2">
